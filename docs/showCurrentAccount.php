    ...
    <div id="popUp" class="py-12 bg-gray-700 transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0 hidden" id="modal">
        <div role="alert" class="container mx-auto w-11/12 md:w-2/3 max-w-lg">
            <div class="relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400">
                ...
                <!-- Form Fields -->
                 <form action="./controller/editCurrentAccount.php" method="POST">
                ...
                <label for="credit-limit" class="text-gray-800 text-sm font-bold leading-tight tracking-normal">Overdraft Limit</label>
                ...
                <label for="transaction-fee" class="text-gray-800 text-sm font-bold leading-tight tracking-normal">Monthly Fee</label>
