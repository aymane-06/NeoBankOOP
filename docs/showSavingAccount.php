        ...
        <table class="min-w-full table-auto border-collapse border border-gray-200">
          <thead>
            <tr class="bg-blue-600 text-white">
              ...
              <th class="px-4 py-2 border-b">Interest Rate</th>
              <th class="px-4 py-2 border-b">Minimum Balance</th>
    ...
    <div id="popUp" class="py-12 bg-gray-700 transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0 hidden" id="modal">
        <div role="alert" class="container mx-auto w-11/12 md:w-2/3 max-w-lg">
            <div class="relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400">
                ...
                <!-- Form Fields -->
                 <form action="./controller/editSavingAccount.php" method="POST">
                ...
                <label for="credit-limit" class="text-gray-800 text-sm font-bold leading-tight tracking-normal">Interest Rate</label>
                <input id="credit-limit" name="CriLi" class="mb-5 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder="Enter Interest Rate" required />
                <label for="transaction-fee" class="text-gray-800 text-sm font-bold leading-tight tracking-normal">Minimum Balance</label>
                <input id="transaction-fee" name="TranFee" class="mb-5 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder="Enter Minimum Balance"  required/>
...
<script src="savingAcc.js"></script>
